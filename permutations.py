...
'/Library/Python/2.7/site-packages/nupic/swarming/exp_generator/ExpGenerator.pyc'
"""
...
permutations = {
  ...
  'modelParams': {
    ...
    'sensorParams': {
      'encoders': {
          u'sine': PermuteEncoder(maxval=1.0, fieldName='sine', w=21, clipInput=True, minval=-1.0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
      },
    },
...
#       report generator
# (generated from minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1\]:window=1000:field=sine")
minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1\]:window=1000:field=sine"
